...
<body>
   ...
   ================================================== -->
    <div id="content-wrap">
     ...
     ?>
                    <p><a
                            href="manage_category.php?id=<?php echo $category['id'];?>"><?php echo $category['name']; ?></a>
                        <?php  
     }
     ?>
                </div>
   ...
   ================================================== -->
    <footer>
        ...
        <div class="row">
            ...
            <p class="copyright">&copy; Copyright 2017. The Blog. &nbsp; Design by <a title="Styleshout"
                    href="http://www.styleshout.com/">Styleshout</a>.</p>

        </div> <!-- End row -->

        <div id="go-top"><a class="smoothscroll" title="Back to Top" href="#top"><i class="fa fa-chevron-up"></i></a>
        </div>
